...
printa_mapa(mapa_visu, mapa_jogador, pais_maquina, pais_jogador)


aloca_jogador(frota_jogador, tamanho_mapa, mapa_jogador, pais_maquina, pais_jogador)
